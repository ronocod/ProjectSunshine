...
import com.example.conor.sunshine.app.MainActivity;
import com.example.conor.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Vector<ContentValues> weatherValuesVector = new Vector<>(weatherArray.length());
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValuesVector.add(weatherValues);
            }

            // add to database
            if (weatherValuesVector.size() > 0) {
                ContentValues[] cvArray = new ContentValues[weatherValuesVector.size()];
                weatherValuesVector.toArray(cvArray);
            ...
            Log.d(LOG_TAG, "Sync Complete. " + weatherValuesVector.size() + " Inserted");
